## Steam-Maestro 功能介绍（原项目FORK自A佬的内部测试版，因中文测试分支已删库停止维护，老用户出现问题请更新到最新版本）
...
### 个人资料管理
* **自定义模板：** 自由编辑内置的STEAM主页美化模板，包括不限于动态展柜头像框主题联动,质量高。
* **隐私设置：** 动态设置下限个人资料设置私密,玩游戏时自动设置为公开,细粒度控制个人信息可见性。
...
* **好友管理：** 支持批量添加、删除好友，创建好友分组。根据好友的最近一次上线，有无给你的主页留言，有无与你发消息交易互动活跃度算法增减排名（如好友资料私密会影响部分准确性）
* **动态友人帐链接管理** 每周例行执行友人帐中主页链接的有效性验证。- 任何检测到的无效链接将被自动化移除以确保友人帐的**持续活跃与内容质量**。
* **基于信任度算法的风险控制**- 通过集成 **SteamRep** 等数据源，结合内置算法，对好友账户进行**实时信任值评估**。- 当账户短时内出现多个开发者封禁、VAC 封禁或负面评价积累时，其信任值将急剧降低，并**触发自动移除机制**，从而有效规避潜在的**高风险交互**。即使好友再多，也大大降低了交易风。
...
* **Steam好友状态追踪：** 追踪好友列表历史,开启本功能后才能启用[智能删除],删除拉黑删除自己好友用户的功能。
